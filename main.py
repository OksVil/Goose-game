...
player_size = (25, 25)
player = pygame.transform.scale(pygame.image.load('player.png').convert_alpha(), (130, 80))
initial_player_position = (50, 310)
player_rect = player.get_rect(topleft = initial_player_position)
player_speed = [1, 1]
...
def create_bonus():
    ...
    bonus_rect = pygame.Rect(random.randint(500, 1200), 0, *bonus_size)
